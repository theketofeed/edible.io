...
const categoryCount = {}
result.food_items.forEach(item => { categoryCount[item.category] = (categoryCount[item.category] || 0) + 1 })
console.log(categoryCount)

console.log('\n=== Testing Normalization (dedupe) ===\n')
const normalizationTest = ['Gluten Free Pasta','Pasta (GF)','gluten-free pasta']
...
const spellingTest = ['chiken breast','tomatoe','banan']
