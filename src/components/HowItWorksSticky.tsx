...
const STEPS = [
	...
	},
	{
		...
		description: 'Edible turns your groceries into a personalized meal plan in seconds — zero food waste.',
	},
	{
		number: '04',
		label: 'COOK',
...
function ScreenPlaceholder({ step }: { step: number }) {
	if (step === 3) return <Loading step={1} compact />
...
function StepBlock({
	...
	return (
		<div
			ref={stepRef}
			data-step={index}
			className="min-h-[80vh] md:min-h-screen flex flex-col justify-center py-16 md:py-0"
		>
			<div className="max-w-md">
				...
				<div className="flex items-baseline gap-4 mb-4">
					<span className="text-6xl md:text-7xl font-black text-purple-200 leading-none select-none">
						{step.number}
					</span>
				...
				{/* Headline */}
				<h3 className="text-2xl md:text-3xl font-black text-gray-900 mb-3 leading-tight tracking-tight">
					{step.title}
				</h3>
...
const HowItWorksSticky = memo(function HowItWorksSticky({
	...
	return (
		...
		>
			{/* Header */}
			<div className="max-w-6xl mx-auto px-6 sm:px-6 md:px-8 pt-16 md:pt-24 pb-8 md:pb-12">
